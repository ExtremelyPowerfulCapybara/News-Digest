...
3. Sends everything to the **Anthropic Codex API**, which writes the editor note, picks stories,
...
│   ├── summarizer.py               # Codex API call -> structured bilingual JSON
...
| `ANTHROPIC_API_KEY` | Anthropic Codex API key |
...
| Anthropic Codex API | Bilingual summarization, editor note, sentiment | ~$0.05-0.08/run |
